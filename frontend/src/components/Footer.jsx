      ...
      <div className="border-t border-surface-100 px-6 md:px-[10%] py-6">
        <div className="flex flex-col md:flex-row justify-between items-center gap-4">
          ...
          <div className="flex gap-3">
            {/* Facebook */}
            <a href="#" title="Facebook" className="w-8 h-8 rounded-lg bg-surface-100/50 flex items-center justify-center text-surface-400 hover:bg-[#1877F2] hover:text-white transition-all duration-200">
            ...
            {/* Twitter / X */}
            <a href="#" title="Twitter" className="w-8 h-8 rounded-lg bg-surface-100/50 flex items-center justify-center text-surface-400 hover:bg-black hover:text-white transition-all duration-200">
            ...
            {/* LinkedIn */}
            <a href="#" title="LinkedIn" className="w-8 h-8 rounded-lg bg-surface-100/50 flex items-center justify-center text-surface-400 hover:bg-[#0A66C2] hover:text-white transition-all duration-200">
              <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 24 24"><path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433a2.062 2.062 0 01-2.063-2.065 2.064 2.064 0 112.063 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z"/></svg>
            </a>
            {/* YouTube */}
            <a href="#" title="YouTube" className="w-8 h-8 rounded-lg bg-surface-100/50 flex items-center justify-center text-surface-400 hover:bg-[#FF0000] hover:text-white transition-all duration-200">
            ...
            {/* Instagram */}
            <a href="#" title="Instagram" className="w-8 h-8 rounded-lg bg-surface-100/50 flex items-center justify-center text-surface-400 hover:bg-gradient-to-br hover:from-[#405DE6] hover:via-[#E1306C] hover:to-[#FFDC80] hover:text-white transition-all duration-200">
